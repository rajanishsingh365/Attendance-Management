...
public class AccountPasswordData
{
	...
	public static java.util.List<administration.proxies.AccountPasswordData> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<administration.proxies.AccountPasswordData> result = new java.util.ArrayList<administration.proxies.AccountPasswordData>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//Administration.AccountPasswordData" + xpathConstraint))
			result.add(administration.proxies.AccountPasswordData.initialize(context, obj));
		return result;
	}
